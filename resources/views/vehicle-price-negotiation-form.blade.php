...
@section('title', 'Price Negotiation | Bilskyen')
...
<div class="container space-y-8 py-6 max-w-4xl">
    ...
    <div class="bg-gray-50 rounded-lg p-6 border border-border">
        <h2 class="text-foreground text-xl font-semibold mb-4">Your Offer</h2>
        <form id="price-negotiation-form" class="space-y-4">
            ...
            <div class="space-y-2">
                <label for="message" class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
                    Your Offer / Message <span class="text-red-500">*</span>
                </label>
                <textarea 
                    id="message" 
                    name="message" 
                    ...
                    placeholder="Enter your offer price or negotiation message. For example: 'I would like to offer DKK 250,000 for this vehicle' or 'Is there any room for negotiation on the price?'"
                ></textarea>
            </div>
            ...
            <div class="flex flex-col sm:flex-row gap-3 pt-4">
                ...
                >
                    <span id="submit-text">Submit Offer</span>
            ...
            if (!response.ok) {
                if (response.status === 401) {
                    ...
                    if (window.showSnackbar) {
                        window.showSnackbar('Please login to submit a price negotiation', 'error');
                    }
                    setTimeout(() => {
                ...
                if (result.errors) {
                    ...
                    const errorMsg = result.message || 'Failed to submit price negotiation. Please try again.';
                    if (window.showSnackbar) {
                ...
                // Success
                const successMsg = result.message || 'Your price negotiation has been submitted successfully!';
