...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if (empty($tableNames)) {
            throw new \Exception('Error: config/permission.php not found. Please run: php artisan config:clear');
        }

        Schema::create($tableNames['permissions'], function (Blueprint $table) {
            $table->bigIncrements('id');
            $table->string('name', 255)->comment('e.g., vehicle.create, vehicle.update');
    ...
    public function down(): void
    {
        ...
        if (empty($tableNames)) {
            throw new \Exception('Error: config/permission.php not loaded. Please run: php artisan config:clear');
        }
