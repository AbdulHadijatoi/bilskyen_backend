...
class StoreContactRequest extends FormRequest
{
    ...
    public function withValidator($validator): void
    {
        $validator->after(function ($validator) {
            ...
            if ($type === 'individual' && !$this->has('name')) {
    ...
    public function messages(): array
    {
        return [
            ...
            'name.required' => 'Name is required for individual contacts.',
            'company_name.required' => 'Company name is required for business contacts.',
            'contact_person.required' => 'Contact person is required for business contacts.',
