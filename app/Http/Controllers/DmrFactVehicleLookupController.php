...
class DmrFactVehicleLookupController extends Controller
{
    ...
    public function lookupByRegistration(Request $request): JsonResponse
    {
        ...
        try {
            $data = $this->dmrFactVehicleLookupService->lookupByRegistration($request->registration);
            ...
            Log::error('DmrFactVehicleLookupController::lookupByRegistration', [
                'error' => $e->getMessage(),
                'file' => $e->getFile(),
                'line' => $e->getLine(),
            ]);
